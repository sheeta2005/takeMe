...
const pointsList = ref([
  { id: 1, type: '助餐服务', points: 50, time: '2026-05-18' },
  { id: 2, type: '助洁服务', points: 80, time: '2026-05-17' }
])
</script>
...
.points-item { display: flex; justify-content: space-between; padding: 12px 0; border-bottom: 1px solid #eee; }
