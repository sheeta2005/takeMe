  ...
  <div class="page-container">
    ...
    <div class="table-card">
      <el-table :data="userList" border stripe style="width: 100%">
        ...
        <el-table-column prop="emergencyName" label="紧急联系人" width="120" align="center" />
        <el-table-column prop="emergencyPhone" label="紧急电话" width="130" align="center" />
...
import { searchUser, addUser, updateUser, deleteUser } from '@/api/admin'
...
const fetchUsers = async () => {
  try {
    ...
    const res = await searchUser(
      ...
      filterGender.value !== '' ? filterGender.value : undefined,
      startDate,
      endDate
    )
